...
class CognitoStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        restrict_function_name = "lambda-restrict-domain"
        restrict_function_path = Path(os.getcwd()).parent.joinpath("lambda/validate_email_domain")

        print("restrictlambda path at " + str(restrict_function_path))
        domain_restrict_lambda = lambda_python.PythonFunction(
            ...
            index="main.py",
            entry=str(restrict_function_path),
        )
